...
<x-mail::button :url="route('requests.show', $request->id)">
Ver Solicitud (Propia)
</x-mail::button>

<x-mail::button :url="route('management.requests.show', $request->id)" color="success">
Ver Solicitud (Admin)
</x-mail::button>

<x-mail::button :url="route('accounting.requests.show', $request->id)" color="success">
