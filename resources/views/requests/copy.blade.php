...
@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Copiar</li>
        </ol>
    </nav>
    <x-alert></x-alert>
@endsection
...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card" x-data="{ isTransfer: {{$requestModel->is_transfer}} }">
                    ...
                    <div class="card-body">
                        ...
                        <div x-show="isTransfer" class="row">
                            <x-adminlte-input fgroup-class="col-md-4" name="bank" label="Banco *" placeholder="banco"
                                label-class="text-lightblue" enable-old-support required
                                value="{{ $requestModel->bank }}" x-bind:disabled="!isTransfer" />
                            <x-adminlte-input fgroup-class="col-md-4" name="card" label="Tarjeta/CLABE *"
                                ...
                                value="{{ $requestModel->card }}" x-bind:disabled="!isTransfer" />
                            <x-adminlte-input fgroup-class="col-md-4" name="account" label="Cuenta" placeholder="cuenta"
                                ...
                                data-inputmask="'mask': '****-****-****-****[-****]'"
                                value="{{ $requestModel->account }}" x-bind:disabled="!isTransfer" />
                            <x-adminlte-input fgroup-class="col-md-4" name="branch" label="Sucursal"
                                ...
                                value="{{ $requestModel->branch }}" x-bind:disabled="!isTransfer" />
                            <x-adminlte-input fgroup-class="col-md-4" name="reference" label="Referencia"
                                ...
                                value="{{ $requestModel->reference }}" x-bind:disabled="!isTransfer" />
                            <x-adminlte-input fgroup-class="col-md-4" name="covenant" label="Convenio"
                                ...
                                value="{{ $requestModel->covenant }}" x-bind:disabled="!isTransfer" />
                        </div>
