...
@section('title_prefix', "Co-Solicitud #{$requestModel->id} | ")

@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('accounting.requests.index') }}">Contabilidad</a></li>
...
@section('content')
    ...
    @endif
    <livewire:Requests.Accounting.RequestShow :requestModelId="$requestModel->id" />
