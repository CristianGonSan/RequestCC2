        ...
        new MutationObserver(() => {
            ...
            @forelse ($messages as $message)
                @if ($message->user_id === $userId)
                    <div class="d-flex justify-content-end my-2 mr-1" wire:key="message-{{ $message->id }}">
                ...
                @else
                    <div class="d-flex justify-content-start my-2" wire:key="message-{{ $message->id }}">
            ...
            @empty
                <div class="d-flex flex-column align-items-center justify-content-center text-muted h-100 py-5">
                    <i class="fas fa-comment-alt fa-2x mt-2"></i>
                    No hay mensajes aún.
                </div>
            @endforelse
        </div>
