                ...
                <tbody>
                    @forelse ($costCenters as $costCenter)
                        <tr>
                            ...
                            <td>{{ $costCenter->company?->name ?? 'Sin Empres' }}</td>
                            <td class="long-text">{{ $costCenter->description ?? 'Sin Descripción' }}</td>
                            <td>{{ $costCenter->created_at->format('d/m/Y') }}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('admin.cost-centers.show', $costCenter->id) }}" class="btn btn-outline-info btn-sm">
