    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5>{{ $type->name }} #{{ $type->id }}</h5>
                <p class="mb-0">Clave: {{ $type->key }}</p>
                @if ($type->enabled)
            ...
            <div class="card-header" wire:ignore.self>
                <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                    ...
                    <div class="dropdown-menu" wire:ignore.self>
                        ...
                        @endif
                        <button type="button" class="dropdown-item" wire:confirm='¿Eliminar este Tipo?'
                                wire:click='delete()'>
                                Eliminar
                        </button>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>{{ $type->created_at->format('d/m/Y h:i:s a') }}</p>
                            </div>
                            <div class="col-md-6">
                                <strong>Última Actualización:</strong>
                                <p class="mb-0">{{ $type->updated_at->format('d/m/Y h:i:s a') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form wire:submit.prevent="save">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <x-adminlte-input fgroup-class="col-md-12" name="key" label="Clave"
                                        placeholder="llave unica" type="text" label-class="text-lightblue"
                                        wire:model.defer="key" autocomplete="off" />
                                ...
                                <tbody>
                                    @forelse ($requests as $request)
                                        <tr wire:key='request-{{ $request->id }}'>
                                            ...
                                            <td>
                                                <a href="{{ route('management.requests.show', $request->id) }}" target="_blank">
                                                    <i class="fa-solid fa-arrow-up-right-from-square text-info"></i>
                                                </a>
                                            </td>
                                        </tr>
