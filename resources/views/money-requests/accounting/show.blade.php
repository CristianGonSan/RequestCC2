...
@section('title_prefix', "Co-Solicitud #{$moneyRequest->id} | ")

@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Inicio</a></li>
            <li class="breadcrumb-item"><a href="{{ route('accounting.money-requests.index') }}">Contabilidad</a></li>
...
@section('content')
    ...
    @endif
    <livewire:MoneyRequests.Accounting.RequestShow :MoneyRequestId="$moneyRequest->id" />
