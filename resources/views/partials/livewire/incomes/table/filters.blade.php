...
<div class="form-row my-1">
    <x-adminlte-select fgroup-class="col-md-4 col-6 mb-0" class="custom-select" name="orderBy"
        ...
        <option value="income_date">Fecha</option>
    ...
    <x-adminlte-select fgroup-class="col-md-4 col-6 mb-0" class="custom-select" name="orderDirection"
    ...
    <div class="form-group col-md-2 col-6 mb-0">
        <label class="text-muted mb-0">Monto mínimo</label>
        <input type="number" class="form-control" min="0" step="0.01" placeholder="-∞"
            wire:model.live.debounce.600ms="filters.minAmount" />
    </div>

    <div class="form-group col-md-2 col-6 mb-0">
        <label class="text-muted mb-0">Monto máximo</label>
        <input type="number" class="form-control" min="0" step="0.01" placeholder="∞"
            wire:model.live.debounce.600ms="filters.maxAmount" />
    </div>
