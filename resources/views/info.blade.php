...
@section('content')
    <div class="">
        ...
        <ul>
            <li>Accede a la sección de <a href="{{ route('requests.create') }}">Nueva Solicitud</a>, en la barra lateral izquierda.</li>
        ...
        <ul>
            ...
            <li><strong>Transferencia:</strong> Selecciona esta opción si prefieres realizar el pago mediante transferencia bancaria.</li>
        </ul>

        <!-- Sección: Campos Obligatorios -->
        <h3 id="campos-obligatorios">Campos Obligatorios</h3>
        <p>Asegúrate de completar todos los campos obligatorios marcados con un asterisco (*). Estos campos son esenciales para procesar tu solicitud correctamente.</p>
        ...
        <ul>
            ...
            <li>Recibirás una notificación por correo electrónico indicando si tu solicitud ha sido aceptada o rechazada.</li>
            <li>Si es rechazada, puede revisar los mensajes en la solicitud, el encargado pudo haber dejado el motivo.</li>
            <li>Mientras la solicitud esté <strong class="text-warning">Pendiente</strong>, puede ser editada o eliminada por el solicitante.</li>
        </ul>
